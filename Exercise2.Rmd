...
learning2014 <- lrn14 %>% select(gender, Age, attitude, deep, stra, surf, Points)

# see the dimensions and structure of the new dataset
dim(learning2014)
str(learning2014)
...
# adjust the regression model with multiple explanatory variables
my_model2 <- lm(points ~ attitude + stra + surf, data = learning2014)

# print out a summary of the model anew
summary(my_model2)
